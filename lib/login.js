...
function getKubeconfig() {
    ...
    if (method == 'kubeconfig') {
        ...
        console.log('what is this', k8sSecret);
        var parsedk8sSecret = jsyaml.safeLoad(k8sSecret);
        console.log('what did this become', parsedk8sSecret);
        throw Error(util.format("got %s \n found %s ", k8sSecret, JSON.stringify(parsedk8sSecret));
